...
import { d1Request, deductCredits, generateFormWithAI, publishPublicFormSnapshot } from '@/lib/api';
      ...
      <div className="min-h-screen bg-slate-50 font-sans pb-20 text-slate-900">
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 sticky top-0 z-10 shadow-sm">
          <div className="flex items-center gap-4">
            <a href="http://localhost:3001/dashboard" className="p-2 -ml-2 text-slate-400 hover:text-slate-700 bg-slate-50 hover:bg-slate-100 rounded-lg flex items-center gap-2 text-sm font-semibold transition-colors">
          ...
          <div className="hidden sm:flex items-center gap-2 bg-indigo-50 border border-indigo-100 px-3 py-1.5 rounded-lg text-xs font-semibold text-indigo-700">
            ...
            <span>Pembuatan form: 5 Kredit (Fitur ekspor & uji statistik GRATIS selamanya)</span>
          </div>
        </header>
        ...
        <aside className="w-full md:w-64 bg-white rounded-3xl border border-slate-200 p-4 shadow-sm shrink-0 sticky top-24">
          <div className="flex md:flex-col gap-2 overflow-x-auto pb-2 md:pb-0 hide-scrollbar">
            <button
              ...
              className={`flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-2xl transition-colors whitespace-nowrap ${
                activeTab === 'builder' ? `${theme.pale} ${theme.text}` : 'text-slate-600 hover:bg-slate-50'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center justify-between gap-3 px-4 py-3 text-sm font-medium rounded-2xl transition-colors whitespace-nowrap ${
                activeTab === 'data' ? `${theme.pale} ${theme.text}` : 'text-slate-600 hover:bg-slate-50'
              }`}
            >
              <div className="flex items-center gap-3">
            ...
            <button
              ...
              className={`flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-2xl transition-colors whitespace-nowrap ${
                activeTab === 'analysis' ? `${theme.pale} ${theme.text}` : 'text-slate-600 hover:bg-slate-50'
              }`}
            >
