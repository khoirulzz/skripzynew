...
export default function FeatureOnboardingModal({ featureId }: { featureId: string }) {
          ...
          <div className="flex items-center justify-between gap-3">
            {currentStep > 0 ? (
              <button 
                ...
                style={{ color: "#64748b", backgroundColor: "color-mix(in srgb, #ffffff 80%, transparent)" }}
              >
            ...
            <button 
              ...
              style={{ 
                ...
                color: "white",
                boxShadow: "0 8px 20px color-mix(in srgb, #4f46e5 25%, transparent)"
              }}
            >
